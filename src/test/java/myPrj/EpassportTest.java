 ...
 * 
 * import com.google.common.io.Files; import pagerepo.EpassportNepal;
 * 
 * public class EpassportTest extends BaseClass {
 * 
 * WebDriverWait waitEpassport; WebDriverWait wait; WebDriverWait waitDropdown;
 * WebDriverWait waitApplyForPassport; WebDriverWait waitDropdownAppointment;
 * WebDriverWait waitListOfcurrentDates; WebDriverWait waitSelectAnHourElement;
 * WebDriverWait waitNearestEnrollmentCenterText; WebDriverWait
 * waitCaptchaElement; JavascriptExecutor appointmentDropdownMaster;
 * JavascriptExecutor scroll; JavascriptExecutor scrollIssuance;
 * JavascriptExecutor countryDropdown; JavascriptExecutor selectOther;
 * JavascriptExecutor appointmentDropdown; JavascriptExecutor
 * optionThreeAppointment; JavascriptExecutor selectAnHour; JavascriptExecutor
 * clickSecondActiveDate; String destination = "./screenshots/3.png"; int
 * activeDatesClicked = 0;
 * 
 * @Test public void verifyEpassportForm() throws InterruptedException,
 * IOException {
 * 
 ...
 * 
 * waitEpassport = new WebDriverWait(driver, Duration.ofSeconds(10)); try {
 * waitEpassport.until( ExpectedConditions.visibilityOfElementLocated(By.
 * xpath("(//a[text()='Apply for ePassport'])[1]"))) .click(); } catch
 * (org.openqa.selenium.TimeoutException e) { // TODO Auto-generated catch block
 * 
 * waitEpassport.until( ExpectedConditions.visibilityOfElementLocated(By.
 * xpath("(//a[text()='Apply for ePassport'])[1]"))) .click();
 ...
 * 
 * if (!windowId.equals(windowsIds)) { driver.switchTo().window(windowId); } }
 * waitApplyForPassport = new WebDriverWait(driver, Duration.ofSeconds(10));
 * 
 * try { waitApplyForPassport.until( ExpectedConditions.elementToBeClickable(By.
 * xpath("//a[contains(text(),'Apply for Passport')]"))) .click(); } catch
 * (org.openqa.selenium.ElementClickInterceptedException e) { // TODO
 * Auto-generated catch block waitApplyForPassport.until(
 * ExpectedConditions.elementToBeClickable(By.
 * xpath("//a[contains(text(),'Apply for Passport')]"))) .click();
 * System.out.println("I have to be executed for clicking Apply for Passport");
 * // e.printStackTrace(); } System.out.println("Text is:" +
 * ePassportLink.applyForPassportElement().getText());
 * System.out.println("I am proceeded and clicked"); Actions actionsPassport =
 * new Actions(driver); wait = new WebDriverWait(driver,
 * Duration.ofSeconds(10));
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.
 * xpath("//h3[text()='First Issuance']")));
 * actionsPassport.moveToElement(ePassportLink.firstIssuanceElement()).build().
 * perform(); try { ePassportLink.firstIssuanceElement().click(); } catch
 * (org.openqa.selenium.ElementClickInterceptedException e) { // TODO
 * Auto-generated catch block
 * actionsPassport.moveToElement(ePassportLink.firstIssuanceElement()).build().
 * perform(); ePassportLink.firstIssuanceElement().click();
 * System.out.println("I have to be executed for Issuance Click retry");
 * 
 * // e.printStackTrace(); } System.out.println("Issuance Link Clicked!");
 * scrollIssuance = (JavascriptExecutor) driver;
 * scrollIssuance.executeScript("arguments[0].scrollIntoView();",
 * ePassportLink.ordinaryLinkElement());
 * scrollIssuance.executeScript("arguments[0].click();",
 * ePassportLink.ordinaryLinkElement());
 * scrollIssuance.executeScript("arguments[0].click();",
 * ePassportLink.proceedElement());
 * scrollIssuance.executeScript("arguments[0].click();",
 * ePassportLink.iAgreeElement()); System.out.println("I agree Clicked!");
 * waitDropdown = new WebDriverWait(driver, Duration.ofSeconds(10));
 * waitDropdown.until(ExpectedConditions .visibilityOfElementLocated(By.xpath(
 * "(//div[@class='mat-select-arrow-wrapper'])[1]"))); countryDropdown =
 * (JavascriptExecutor) driver;
 * countryDropdown.executeScript("arguments[0].click();",
 * ePassportLink.countryDropdownElement()); selectOther = (JavascriptExecutor)
 * driver; selectOther.executeScript("arguments[0].click();",
 * ePassportLink.otherSelectionElement());
 * 
 * waitNearestEnrollmentCenterText = new WebDriverWait(driver,
 * Duration.ofSeconds(90));
 * waitNearestEnrollmentCenterText.until(ExpectedConditions.
 * visibilityOfElementLocated(
 * By.xpath("//h3[contains(.,'Please choose the nearest enrollment center')]")))
 * ; waitDropdownAppointment = new WebDriverWait(driver,
 * Duration.ofSeconds(10)); waitDropdownAppointment.until(
 * ExpectedConditions.elementToBeClickable(By.xpath(
 * "(//div[@class='mat-select-arrow-wrapper'])[2]")));
 * 
 * appointmentDropdown = (JavascriptExecutor) driver;
 * appointmentDropdown.executeScript("arguments[0].click();",
 * ePassportLink.appointmentLocationElement());
 * 
 * optionThreeAppointment = (JavascriptExecutor) driver;
 * optionThreeAppointment.executeScript("arguments[0].click();",
 * ePassportLink.optionFourElement());
 * 
 * String optionFourValue = ePassportLink.optionFourElement().getText();
 * System.out.println("Option Three value that has been clicked is :" +
 * optionFourValue); while (!optionFourValue.equals(" NE, Paris ")) {
 * 
 * waitDropdownAppointment = new WebDriverWait(driver, Duration.ofSeconds(10));
 * waitDropdownAppointment.until(
 * ExpectedConditions.elementToBeClickable(By.xpath(
 * "(//div[@class='mat-select-arrow-wrapper'])[2]"))); appointmentDropdown =
 * (JavascriptExecutor) driver;
 * appointmentDropdown.executeScript("arguments[0].click();",
 * ePassportLink.appointmentLocationElement());
 * 
 ...
 * ePassportLink.optionFourElement().getText()); System.out.println(
 ...
 * xpath("//tbody[contains (@class, 'ng-tns')]")));
 * 
 * 
 ...
 * 
 * 
 * int clickedDates = 0; for (WebElement listOfActiveDate :
 * ePassportLink.listOfAllClickableDatesInActiveCalendar()) { if (clickedDates
 * == 0) { // Skip the first date clickedDates++; continue; }
 * System.out.println("From Second Active Dates in an Active Calendar shown : "
 * + listOfActiveDate.getText()); try { listOfActiveDate.click(); } catch
 * (org.openqa.selenium.ElementClickInterceptedException e) {
 * 
 * clickSecondActiveDate = (JavascriptExecutor) driver;
 * clickSecondActiveDate.executeScript("arguments[0].click();",
 * listOfActiveDate);
 * 
 * System.out.println("Retrying and grabbing current active date again");
 * 
 * // e.printStackTrace(); } break; // Break out of the loop after clicking the
 * second date }
 * 
 ...
 * 
 * System.out.println("List of Available time shown :" +
 * listOfAvailableTime.getText());
 * 
 * listOfAvailableTime.click();
 * 
 * System.out.println("Appointment Time is selected"); break; }
 * 
 * 
 ...
 * 
 * 
 * // Wait for the captcha image to be visible waitCaptchaElement = new
 * WebDriverWait(driver, Duration.ofSeconds(10)); waitCaptchaElement
 * .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
 * "//img[@class='captcha-img']")));
 * 
 * // Capture screenshot of the captcha image File source =
 * driver.findElement(By.xpath("//img[@class='captcha-img']")).getScreenshotAs(
 * OutputType.FILE); // Save the screenshot String captchaImagePath =
 * "D:\\cabtmDashboardAutomation\\testSelenium\\tessdata\\captcha.png";
