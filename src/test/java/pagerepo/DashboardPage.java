...
public class DashboardPage {
	...
	private By visaOverview = By.xpath("//h4[text()='Visa Overview']");
	private By invoiceStatus = By.xpath("//h4[text()='Invoice Status']");
	private By charts = By.xpath("(//*[@class='recharts-surface'])[1]");	
	private By degreeStructureText = By.xpath("//h4[text()='Degree Structure']");
	private By insuranceverviewText = By.xpath("//h4[text()='Insurance Overview']");
	private By totalSalesText = By.xpath("(//div[@class='uppercase text-[14px] text-neutral-500 font-medium'])[1]");
	private By totalRefundedText = By.xpath("//div[.='TOTAL REFUNDED']");
	private By totalRefundRejectedText = By.xpath("//div[.='TOTAL REFUND REJECTED']");
	private By insuranceOverviewNprGroup = By.xpath("//div[@class='uppercase text-[14px] text-neutral-500 font-medium']/following-sibling::div");
	...
	// For Verifying as a group 
	public List<WebElement> insuranceOverviewNprGroup() {
